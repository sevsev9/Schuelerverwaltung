...
public class Main_ctr {
    ...
    private Image SampleStudent = new Image(Main.class.getResourceAsStream("assets/img/sample_student.png"));
    ...
    public void init() {
        ...
        if (img == null) {
            ...
            //Image Ressources
            Image max = new Image(Main.class.getResourceAsStream("assets/img/max.jpg"));
    ...
    public void search(ActionEvent actionEvent) {
        ...
        addAll(val, opt_fname, opt_lname, opt_uname);
        addAll(val, opt_email, opt_school, opt_class);
    ...
    private void addAll(ArrayList<String> val, TextField opt_fname, TextField opt_lname, TextField opt_uname) {
